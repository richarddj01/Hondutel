<!-- resources/views/telefonos/index.blade.php -->
<x-app-layout>
    <x-slot name="header">
                    ...
                    <tr>
                        ...
                        <td>
                            <form action="{{ route('telefonos.destroy', $telefono) }}" method="POST">
                                ...
                                <a class="btn btn-info" href="{{ route('telefonos.show', $telefono->numero) }}">
                                    <i class="bi-eye-fill"></i>
                                </a>
                                @endcan

                                @can('Upd Telefonos')
                                <a class="btn btn-warning" href="{{ route('telefonos.edit', $telefono->numero) }}">
